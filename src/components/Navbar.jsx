        ...
        <div className="navbar-end flex items-center space-x-4 pr-3" ref={dropdownRef}>
          <div className="relative">
            <button
              ...
              className="p-2 rounded-full bg-white border shadow hover:bg-gray-100 relative cursor-pointer"
            >
          ...
          {session && (
            <>
              <button
                className="hidden lg:block btn btn-sm md:btn-md rounded bg-gradient-to-r from-green-400 to-blue-500 text-white"
          ...
          {!session && (
            <Link
              href="/auth/login"
              className="btn rounded transition border-none btn-sm md:btn-md bg-blue-500 text-white hover:bg-blue-600"
            >
              Login
            </Link>
          )}
