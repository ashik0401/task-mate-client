...
export default function Home() {
  return (
    <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 flex flex-col-reverse md:flex-row  gap-8 items-center justify-center">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <Link href="/tasks/create">
            <button className="bg-white text-green-600 font-semibold px-6 py-3 rounded-lg shadow hover:bg-gray-100 transition-all">
